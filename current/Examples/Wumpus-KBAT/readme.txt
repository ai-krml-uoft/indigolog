Mini getting-started guide to get the Wumpus Example running:
...
3. Go to directory <mypath>/indigolog-linux-0.5a/Examples/Wumpus-KBAT/WumpusApplet
...
5. Consult main.pl and execute goal "main". Several controllers will be offered.
